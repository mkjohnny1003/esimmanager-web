(() => {
  ...
  // The root page is Traditional Chinese. Only on a first visit do we redirect
  // it once according to the device language. A saved choice or a language in
  // the URL always wins, so the site never keeps changing a user's choice.
